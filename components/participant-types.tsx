  ...
  return (
      <section id="participants" className="py-24 px-6 bg-card">
        <div className="max-w-7xl mx-auto">
          <p className="text-accent font-semibold text-sm tracking-widest uppercase mb-6">Diversity
            is Key</p>
          <h2 className="text-3xl sm:text-4xl font-bold text-foreground mb-4">Who Are We Looking
            For?</h2>
          <p className="text-lg text-muted-foreground mb-12 max-w-2xl">
            We are looking for a vibrant mix of participants to create the best possible learning
            environment.
          </p>
          ...
          <p className="text-foreground text-xl font-semibold mt-12 max-w-3xl leading-relaxed border-l-4 border-accent pl-6 py-4">
            We believe that everyone has a place in Web3, and the best growth happens when we learn
            from our collective differences.
          </p>
        </div>
      </section>
  )
